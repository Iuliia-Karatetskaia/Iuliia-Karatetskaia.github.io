...
if (requestCall.length > 0) {
  for (var _i2 = 0; _i2 < requestCall.length; _i2++) {
    var _button = requestCall[_i2];
...
if (feedbackSend.length > 0) {
  for (var _i3 = 0; _i3 < feedbackSend.length; _i3++) {
    var _button2 = feedbackSend[_i3];
...
if (popupCloseIcon.length > 0) {
  var _loop = function _loop(_i4) {
    var elem = popupCloseIcon[_i4];
    elem.addEventListener('click', function () {
      popupClose(elem.closest('.popup'), unlock);
    });
  };

  for (var _i4 = 0; _i4 < popupCloseIcon.length; _i4++) {
    _loop(_i4);
  }
}
