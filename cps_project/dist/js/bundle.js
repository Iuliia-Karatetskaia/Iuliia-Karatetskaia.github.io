...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_swiper_swiper_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../node_modules/swiper/swiper.scss */ "./node_modules/swiper/swiper.scss");
/* harmony import */ var _node_modules_swiper_swiper_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_swiper_swiper_scss__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_swiper_modules_pagination_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../node_modules/swiper/modules/pagination.scss */ "./node_modules/swiper/modules/pagination.scss");
/* harmony import */ var _node_modules_swiper_modules_pagination_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_swiper_modules_pagination_scss__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _node_modules_swiper_modules_navigation_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../node_modules/swiper/modules/navigation.scss */ "./node_modules/swiper/modules/navigation.scss");
/* harmony import */ var _node_modules_swiper_modules_navigation_scss__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_node_modules_swiper_modules_navigation_scss__WEBPACK_IMPORTED_MODULE_2__);
...
function swiperCard() {
  if (window.innerWidth <= 768) {
    if (!init) {
      ...
      for (var i = 0; i < paginationStatus.length; i++) {
        paginationStatus[i].classList.remove('pagination--hidden');
      }

      firstSwiper = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"]('.brand-list__container', {
      ...
      secondSwiper = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"]('.equipment-list__container', {
        modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_5__["Navigation"], swiper_modules__WEBPACK_IMPORTED_MODULE_5__["Pagination"]],
        direction: 'horizontal',
        loop: false,
        pagination: {
      ...
      thirdSwiper = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"]('.price-list__container', {
        modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_5__["Navigation"], swiper_modules__WEBPACK_IMPORTED_MODULE_5__["Pagination"]],
        direction: 'horizontal',
        loop: false,
        pagination: {
    ...
    for (var _i = 0; _i < paginationStatus.length; _i++) {
      paginationStatus[_i].classList.add('pagination--hidden');
    }
  }
}
...
var buttonShow = document.getElementsByClassName('show-all');
var button = document.getElementsByClassName('show-all__button');
var firstContainer = document.querySelector('.content__text');
var secondContainer = document.querySelector('.brand-list__container');
var thirdContainer = document.querySelector('.equipment-list__container');
var arrayButton = [{
...
var buttonClick = function buttonClick(object) {
...
for (var _i2 = 0; _i2 < arrayButton.length; _i2++) {
  buttonClick(arrayButton[_i2]);
}

var openBurger = document.querySelector('.burger-menu');
var body = document.querySelector('.body');
var mainMenu = document.querySelector('.container__wrapper-menu');
var requestCall = document.getElementsByClassName('phone');
var call = document.querySelector('.container__wrapper-call');
var feedbackSend = document.getElementsByClassName('chat');
var feedback = document.querySelector('.container__wrapper-feedback');
var unlock = true;
...
if (requestCall.length > 0) {
  for (var _i3 = 0; _i3 < requestCall.length; _i3++) {
    var _button = requestCall[_i3];
...
if (feedbackSend.length > 0) {
  for (var _i4 = 0; _i4 < feedbackSend.length; _i4++) {
    var _button2 = feedbackSend[_i4];
...
var popupCloseIcon = document.getElementsByClassName('popup-close');

if (popupCloseIcon.length > 0) {
  var _loop = function _loop(_i5) {
    var elem = popupCloseIcon[_i5];
    elem.addEventListener('click', function () {
      popupClose(elem.closest('.popup'), unlock);
    });
  };

  for (var _i5 = 0; _i5 < popupCloseIcon.length; _i5++) {
    _loop(_i5);
  }
}
